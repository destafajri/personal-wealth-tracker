export const copy = {
  ...
  'nav.brand.subtitle': 'Cek keuangan kamu',
  ...
  'snapshot.penghasilan.label': 'Penghasilan/bulan',
  'snapshot.penghasilan.help': 'Take-home pay setelah pajak.',
  ...
  'snapshot.emas.tertahanDerived':
    'Tertahan: {grams} gram (dari {count} kontrak gadai)',
  ...
  'snapshot.emas.atHomeBreakdown':
    '{available}g di tangan, {pawned}g digadai (total {total}g)',
  ...
  'snapshot.emas.fisik.note':
    'Estimasi pakai harga Antam 1gr × 0.93 (spread buyback ~7%).',
  ...
  'gadai.warning.overOwned': 'Yang digadai ({pawned}g) lebih dari total ({owned}g).',
  ...
  'metric.goalHealth.label': 'Goal Health',
  'metric.zone.sehat': 'Sehat',
  'metric.zone.waspada': 'Waspada',
  'metric.zone.bahaya': 'Bahaya',
  'metric.empty.netWorth': 'Net worth keluar kalau aset/utang udah keisi.',
  'metric.empty.modalSiap': 'Isi kas/deposito/RD/crypto dulu.',
  ...
  'metric.empty.allocationDiscipline': 'Tambah saham + target bobot (Day 4).',
  'metric.empty.goalHealth': 'Bikin goal dulu (modul Plan).',
