    ...
    <section>
      ...
      <div class="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
        <div
          ...
          :key="card.key"
          class="flex cursor-not-allowed flex-col items-start gap-2 rounded-[var(--radius-card)] border border-[var(--color-border)] bg-[var(--color-surface-card)] p-4 opacity-60"
        >
          <div class="flex w-full items-center justify-between">
            <component :is="card.icon" :size="20" class="text-[var(--color-primary)]" />
            <span
